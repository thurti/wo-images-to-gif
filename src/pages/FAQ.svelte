...
<PageContainer title="FAQ">
  ...
  <UiSection id="filesize">
    <slot slot="heading">Why is my GIF filesize so large?</slot>
    <p>
      The GIF file format is not very efficient. Using modern video formats like
      webm, avif or mp4 would result in much smaller filesize and better
      quality. To reduce the file size, you can try to reduce the quality, frame
      rate or the resolution settings.
    </p>
  </UiSection>
